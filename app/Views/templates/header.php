...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/headerStyle.css?1.3">
    ...
    <script type="text/javascript" src="/assets/js/utilites.js?1.2"></script>
        ...
        <body id="body-pd">
                ...
                <nav class="my_nav">
                    <div class="text-center">
                        <div class="nav__list mt-4">
                            <a href="/dashboard" title="Dashboard" class="nav__link my_nav_link <?= ($uri->getSegment(1) == 'dashboard' ? 'active-nav-link' : '') ?>">
                                <div class="nav__icon">
                                    <img src="/assets/images/dashboard.svg" class="icon__image" style="filter: <?= ($uri->getSegment(1) == 'dashboard'  ? 'invert(1)' : '') ?>;">
                                </div>
                            ...
                            <a href="/projects" title="Projects" class="nav__link my_nav_link <?= ($uri->getSegment(1) == 'projects'  || $uri->getSegment(1) == 'taskboard'  ? 'active-nav-link' : '') ?>">
                                <div class="nav__icon">
                                    <img src="/assets/images/projects.svg" class="icon__image" style="filter: <?= ($uri->getSegment(1) == 'projects'  || $uri->getSegment(1) == 'taskboard'  ? 'invert(1)' : '') ?>;">
                                </div>
                            ...
                            <a href="/reviews" title="Review Register" class="nav__link my_nav_link <?= ($uri->getSegment(1) == 'reviews'   ? 'active-nav-link' : '') ?>">
                                <div class="nav__icon">
                                    <img src="/assets/images/eye.svg" class="icon__image" style="filter: <?= ($uri->getSegment(1) == 'reviews'  ? 'invert(1)' : '') ?>;">
                                </div>
                            ...
                            <div class="nav__link collapse <?= (($uri->getSegment(1) == 'documents' || $uri->getSegment(1) == 'documents-templates' || $uri->getSegment(1) == 'documents-master' || $uri->getSegment(1) == 'documents-acronyms') ? 'active-nav-link' : '')  ?>">
                                ...
                                <div class=" nav__icon">
                                    <img src="/assets/images/documents.svg" class="icon__image" style="filter: <?= (($uri->getSegment(1) == 'documents' || $uri->getSegment(1) == 'documents-templates' || $uri->getSegment(1) == 'documents-master' || $uri->getSegment(1) == 'documents-acronyms') ? 'invert(1)' : '') ?>;">
                            </div>
                            </a>
                            <a href="/documents" title="Documents" style="margin-left: 5px;" class="nav__name my_nav_link <?= (($uri->getSegment(1) == 'documents' || $uri->getSegment(1) == 'documents-templates' || $uri->getSegment(1) == 'documents-master' || $uri->getSegment(1) == 'documents-acronyms') ? 'text-light' : '')  ?>"">Documents</a>

                                <div class=" nav__icon collapse__link">
                                <img src="/assets/images/chevron-down.svg" class="icon__image" style="width: 1em;height: 1em;filter: <?= (($uri->getSegment(1) == 'documents' || $uri->getSegment(1) == 'documents-templates' || $uri->getSegment(1) == 'documents-master' || $uri->getSegment(1) == 'documents-acronyms') ? 'invert(1)' : '') ?>;">
                        </div>
                    ...
                    <a href="/actionList" title="Action List" class="nav__link my_nav_link <?= (strpos($currentUrl, 'actionList')   ? 'active-nav-link' : '') ?>">
                        <div class="nav__icon">
                            <img src="/assets/images/flash-outline.svg" class="icon__image" style="filter: <?= (strpos($currentUrl, 'actionList')   ? 'invert(1)' : '') ?>;">
                        </div>
                        <span class="nav__name">Action List</span>
                    </a>
                    <a href="/timeTracker" title="Time Tracker" class="nav__link my_nav_link <?= (strpos($currentUrl, 'timeTracker')   ? 'active-nav-link' : '') ?>">
                        <div class="nav__icon">
                            <img src="/assets/images/hourglass-outline.svg" class="icon__image" style="filter: <?= (strpos($currentUrl, 'timeTracker')   ? 'invert(1)' : '') ?>;">
                        </div>
                        <span class="nav__name">Time Tracker</span>
                    </a>
                    <a href="/diagramsList" title="Draw Diagram" class="nav__link my_nav_link <?= (strpos($currentUrl, 'diagrams')   ? 'active-nav-link' : '') ?>">
                        <div class="nav__icon">
                            <img src="/assets/images/color-palette.svg" class="icon__image" style="filter: <?= (strpos($currentUrl, 'diagrams')   ? 'invert(1)' : '') ?>;">
                        </div>
                        <span class="nav__name">Draw Diagram</span>
                    </a>


                    <a href="/risk-assessment" title="Risk Assessment" class="nav__link my_nav_link <?= ($uri->getSegment(1) == 'risk-assessment'   ? 'active-nav-link' : '') ?>">
                        <div class="nav__icon">
                            <img src="/assets/images/shield.svg" class="icon__image" style="filter: <?= ($uri->getSegment(1) == 'risk-assessment'  ? 'invert(1)' : '') ?>;">
                        </div>
                    ...
                    <div class="nav__link collapse <?= ((($uri->getSegment(1) == 'requirements') || $uri->getSegment(1) == 'test-cases' || $uri->getSegment(1) == 'traceability-matrix')  ? 'active-nav-link' : '') ?>">
                        <a href="/traceability-matrix" title="Traceability Matrix" class="collapse__sublink my_nav_link <?= ((($uri->getSegment(1) == 'requirements') || $uri->getSegment(1) == 'test-cases' || $uri->getSegment(1) == 'traceability-matrix')  ? 'text-light' : '') ?>">
                            <div class="nav__icon">
                                <img src="/assets/images/matrix.svg" class="icon__image" style="filter: <?= ((($uri->getSegment(1) == 'requirements') || $uri->getSegment(1) == 'test-cases' || $uri->getSegment(1) == 'traceability-matrix')  ? 'invert(1)' : '') ?>;">
                            </div>
                        </a>
                        <a href="/traceability-matrix" title="Traceability Matrix" style="margin-left: 5px;" class="nav__name collapse__sublink my_nav_link <?= ((($uri->getSegment(1) == 'requirements') || $uri->getSegment(1) == 'test-cases' || $uri->getSegment(1) == 'traceability-matrix')  ? 'text-light' : '') ?>">Traceability</a>

                        <div class="nav__icon collapse__link">
                            <img src="/assets/images/chevron-down.svg" class="icon__image " style="width: 1em;height: 1em;filter: <?= ((($uri->getSegment(1) == 'requirements') || $uri->getSegment(1) == 'test-cases' || $uri->getSegment(1) == 'traceability-matrix')  ? 'invert(1)' : '') ?>;">
                        </div>
                        <ul class="collapse__menu">
                    ...
                    <a href="/inventory-master" title="Assets" class="nav__link my_nav_link <?= ($uri->getSegment(1) == 'inventory-master'   ? 'active-nav-link' : '') ?>">
                        <div class="nav__icon">
                            <img src="/assets/images/cart.svg" class="icon__image" style="filter: <?= ($uri->getSegment(1) == 'inventory-master'  ? 'invert(1)' : '') ?>;">
                        </div>
                    ...
                    <a href="/team" title="Team" class="nav__link my_nav_link <?= ($uri->getSegment(1) == 'team'   ? 'active-nav-link' : '') ?>">
                        <div class="nav__icon">
                            <img src="/assets/images/team.svg" class="icon__image" style="filter: <?= ($uri->getSegment(1) == 'team'  ? 'invert(1)' : '') ?>;">
                        </div>
            ...
            <div class="sidebar-footer">
                ...
                <div class="row justify-content-center d-none" id="footer-icons">
                    <?php $col = "col-6";
                    if (session()->get('is-admin')) : $col = "col-4"; ?>
                        <div class="<?= $col ?>">
